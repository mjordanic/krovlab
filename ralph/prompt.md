...
Local issue files from `.scratch/<feature>/issues/` are provided at start of context. Parse them to understand the open issues.
...
If the task is complete, move the issue file to `.scratch/<feature>/issues/done/`.
