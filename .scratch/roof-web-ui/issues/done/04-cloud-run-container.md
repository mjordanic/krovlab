...
- [x] A Dockerfile starts the Flask app on Python 3.13, `0.0.0.0`, and `PORT`
- [x] README documents the local command and the Cloud Run flags (region, min instances 0, unauthenticated)
- [x] CI does not require a Google Cloud project
- [x] The image serves the same form page as localhost (no second app)
